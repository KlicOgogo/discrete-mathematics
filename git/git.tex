...
\begin{document}
    ...
    \begin{enumerate}
        \item \href{https://www.atlassian.com/git/tutorials/saving-changes/git-commit}{Разбіраемся}, што такое каміт.
        ...
        \item \href{https://git-scm.com/book/en/v2/Git-Branching-Branches-in-a-Nutshell}{Засвойваем} моцны інструмент git, які дазваляе карэктна працаваць з рэпазіторыем. Калі ваш рэпазіторый змяняеце толькі вы, можна не замарачвацца і працаваць толькі з галіной <<master>>, але ў іншых выпадках змяняць <<master>> рэкамендуецца праз \href{https://help.github.com/en/articles/about-pull-requests}{pull request}, а тут ужо складана (нельга) без выкарыстоўвання галін.
